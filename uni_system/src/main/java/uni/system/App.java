...
public class App 
{
    public static void main( String[] args )
    {
      ...
      //student part
      Student s1 = new Student("sora", "sora@123", "12345", CS, "SE",2);
      Student s2 = new Student("sori", "sori@123", "12345", CS, "SE",1);
      Student s3 = new Student("sore", "sore@123", "12345", CS, "SE",3);
      ...
      //enrollment part
      Enrollment e1 = new Enrollment( s1, c1, 1, 2 );
      Enrollment e2 = new Enrollment(s2, c2, 1, 2);
      Enrollment e3 = new Enrollment(s3, c3, 0, 0);
      // add to student 
